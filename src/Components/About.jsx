...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center px-6 md:px-20 bg-white dark:bg-[#071c24] mt-16 md:mt-20
    ...
    >
      <div className="max-w-4xl ">
        ...
        <p className="text-lg leading-relaxed mb-6 text-gray-600 dark:text-gray-400">
          I'm a Full Stack Developer with hands-on experience in Web Development
          and Android Application Development. I enjoy building practical and
          scalable applications that solve real problems.
        </p>

        <p className="text-lg leading-relaxed mb-10 text-gray-600 dark:text-gray-400">
          My work focuses on creating responsive user interfaces and writing
          structured backend logic. I aim to write clean, organized, and
          maintainable code.
        </p>
